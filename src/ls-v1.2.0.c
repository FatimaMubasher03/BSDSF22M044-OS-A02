 ...
 * Add column display (default) + long listing (-l) support to ls.
 *
 * Usage:
 *   $ lsv1.2.0
 *   $ lsv1.2.0 -l
 ...
 *
 * Notes:
 * - Default (no -l): shows column layout, “down then across”.
...
void do_ls(const char *dir, int long_format)
{
    ...
    /* ────────────────────────────────────────────────
     *  FEATURE: Default Column Display (v1.2.0)
     * ──────────────────────────────────────────────── */
    if (!long_format)
    {
        struct dirent *entry;
    ...
    /* ────────────────────────────────────────────────
     *  FEATURE: Long Listing (-l) (from v1.1.0)
     * ──────────────────────────────────────────────── */
