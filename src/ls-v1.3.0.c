so i want to add this code in ls-v1.3.0.c
...
and this code to ls-v1.4.0.c
ls-v1.3.0.c fully updated to v1.4.0 
...
and then add both to their respective branches and the n merge them in main
